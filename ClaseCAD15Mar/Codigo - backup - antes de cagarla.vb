Module Codigo
    ...
    Public Function seguimientoCalle()
        ...
        For Each vehiculo In conjuntoVehiculos
            nextStreet = getNextStreet(getNextPosibleStreets(vehiculo, conjuntoCalles, numCalles), numCalles)
        ...
        'moverVehiculo(conjuntoCalles, conjuntoVehiculos, 200, nextStreet)
    ...
    Public Function GirarVehiculosSegunOrientacionDeLaCalle(conjuntoCalles As AcadSelectionSet, conjuntoVehiculos As AcadSelectionSet, numCalles As Integer, lista As ListBox) As AcadEntity
        ...
        Dim nextStreet As AcadEntity = Nothing
        ...
        For Each calle In conjuntoCalles
            ...
            For Each vehiculo In conjuntoVehiculos
                ...
                'Si el vehiculo esta en su punto de partida(donde aparece por primera vez) girara para alinearse con la calle en la que 
                'aparece, de lo contrario, buscara en que calle se encuentra, y analizara cuales son las siguientes calles que colindan
                'con la calle en la que se encuentra, seleccionara una aleatoriamente y girara para alinearse a esa calle 
                GetDictionaryVehiculo(vehiculo, "START", valor)
                If valor = "TRUE" Then
                    nextStreet = calle
                Else
                    If (centroideVehiculo(0) = p2(0) And centroideVehiculo(1) = p2(1)) Then
                        nextStreet = getNextStreet(AnalizarInterseccion(conjuntoCalles, calle, numCalles), numCalles)
                    End If
    ...
    End Function
    Public Function getNextPosibleStreets(vehiculo As AcadEntity, conjuntoCalles As AcadSelectionSet, numCalles As Integer) As Collection
        Dim calle As AcadEntity
        Dim p1calle() As Double
        Dim centoride() As Double
        Dim callesenlainterseccion As Collection = Nothing
