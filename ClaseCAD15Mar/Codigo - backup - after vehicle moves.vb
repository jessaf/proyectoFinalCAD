        ...
        For Each element In conjunto
            Select Case element.ObjectName
                Case "AcDbLine"
                    ...
                    'point4Auto(1) = p1(1) + 2
                    'point4Auto(2) = 0
                    'automovil = DOCUMENTO.ModelSpace.AddSolid(point1Auto, point2Auto, point3Auto, point4Auto)
                    ...
                    'vehiculo.Update()
                    'objDrawingObject.Rotate varBasePoint, dblRotationAngleobj
