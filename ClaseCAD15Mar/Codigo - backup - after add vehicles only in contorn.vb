Module Codigo
    ...
    Public Sub getXdata(entidad As AcadEntity, nameXrecord As String, valor As String)
        'extrayendo datos
    ...
    Public Function seguimientoCalle()
        ...
        'revisando todos los elementos del plano
        Dim conjunto As AcadSelectionSet
        Dim conjuntoCalles As AcadSelectionSet
        Dim conjuntoTemp As AcadSelectionSet
        Dim conjuntoVehiculos As AcadSelectionSet
